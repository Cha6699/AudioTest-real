"""
ESC-50 Supervised Classification (SVM)
"""
...
print("=" * 70)
print("ESC-50 Supervised Classification (SVM)")
print("=" * 70)
...
run_dir = results_dir / f"svm_{timestamp}"
...
print("\n" + "-" * 70)
print("SVM Classification (5-fold Cross Validation)")
print("-" * 70)
...
for fold in [1, 2, 3, 4, 5]:
    ...
    svm.fit(train_emb_scaled, train_labels)
    
    pred_labels = svm.predict(test_emb_scaled)
...
with open(run_dir / 'report.txt', 'w') as f:
    f.write("=" * 70 + "\n")
    f.write("ESC-50 SVM Classification Results\n")
    f.write("=" * 70 + "\n")
    f.write(f"\nTimestamp: {timestamp}")
